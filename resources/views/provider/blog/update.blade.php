...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading" style="border-bottom: 1px solid #ddd; margin-bottom: 20px;">
            <h5 class="panel-title">Blog Update</h5>
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('provider.blog.update', [$blog->id])}}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="title" value="{{$blog->title}}" class="form-control" required="required" placeholder="Title">
                        </div>
                    </div>
                    <!-- /basic text input -->
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea name="description" id="description" class="form-control" required="required" placeholder="Description">{{$blog->description}}</textarea>
                        </div>
                    </div>
                    <!-- /basic textarea -->
                            ...
                            <div class="file-preview" id="custom_file_preview">
                                ...
                                <div class="file-preview-thumbnails">
                                    <div class="file-preview-frame" id="preview-1603644588432-0">
                                        <img src="{{ asset('uploads/blog/'.$blog->image)}}" class="file-preview-image" title="{{$blog->image}}" alt="{{$blog->image}}" style="width:auto;height:160px;">
                                    </div>
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-1">
                            <div class="checkbox checkbox-switch">
                                <label>
                                    <input type="checkbox" name="status" @if($blog->status == 1) checked @endif value="1" data-on-text="Yes" data-off-text="No" class="switch">
                                </label>
                            </div>
                        </div>
                    </div>
