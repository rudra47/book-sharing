...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading" style="border-bottom: 1px solid #ddd; margin-bottom: 20px;">
            <h5 class="panel-title">Course Teacher Create</h5>
            ...
            <form class="form-horizontal form-validate-jquery" action="{{route('provider.teacher.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="teacher_phone" class="form-control" placeholder="Teacher Phone">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="qualifications" class="control-label col-lg-2">Qualifications <span class="text-danger">*</span></label>
                        <div class="col-lg-10">
                            <textarea name="qualifications" id="qualifications" class="form-control" required="required"></textarea>
                        </div>
                    </div>
                    <!-- /basic text input -->
