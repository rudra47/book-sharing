...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('provider.author.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="text-right">
                    ...
                    <a href="{{route('provider.author.index')}}" class="btn btn-default">Back To List <i class="icon-backward2 position-right"></i></a>
                </div>
            </form>
        </div>
    </div>
