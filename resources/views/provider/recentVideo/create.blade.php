...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading" style="border-bottom: 1px solid #ddd; margin-bottom: 20px;">
            <h5 class="panel-title">Recent Video Create</h5>
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('provider.recentVideo.store')}}" method="POST">
                @csrf
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="video_id" class="form-control" required="required" placeholder="Example: ArlvRVdn9XI&t">
                        </div>
                    </div>
                    <!-- /basic text input -->
