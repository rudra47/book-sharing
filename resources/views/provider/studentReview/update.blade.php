...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading" style="border-bottom: 1px solid #ddd; margin-bottom: 20px;">
            <h5 class="panel-title">Student Review Update</h5>
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('provider.studentReview.update', [$review->id])}}" method="POST">
                @method('PUT')
                @csrf
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="student_name" class="form-control" required="required" placeholder="Review Student Name" value="{{$review->student_name}}">
                        </div>
                    </div>
                    <!-- /basic text input -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <textarea rows="5" cols="5" name="review" class="form-control" required="required" placeholder="Review Text">{{$review->review}}</textarea>
                        </div>
                    </div>
                    <!-- /basic textarea -->
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="checkbox checkbox-switch">
                                <label>
                                    <input type="checkbox" name="status" @if($review->status == 1) checked @endif value="1" data-on-text="Yes" data-off-text="No" class="switch">
                                </label>
                            </div>
                        </div>
                    </div>
