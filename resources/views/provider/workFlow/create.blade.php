...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading" style="border-bottom: 1px solid #ddd; margin-bottom: 20px;">
            <h5 class="panel-title">Work Flow Create</h5>
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('provider.workFlow.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label text-semibold">Specify file extensions:</label>
                        <div class="col-lg-6">
                ...
                <div class="text-right">
                    ...
                    <a href="{{route('provider.workFlow.index')}}" class="btn btn-default">Back To List <i class="icon-backward2 position-right"></i></a>
                </div>
            </form>
        </div>
    </div>
