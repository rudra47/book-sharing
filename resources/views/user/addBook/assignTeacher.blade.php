...
<div class="page-header">
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="{{route('user.assignPackage.index')}}">Assign Package</a></li>
...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-body">
            <form class="form-horizontal form-validate-jquery" action="{{route('user.courseAssignTeacher', [$course_id])}}" method="POST">
                @csrf
                ...
                <div class="text-right">
                    ...
                    <a href="{{route('user.course.index')}}" class="btn btn-default">Back To List <i class="icon-backward2 position-right"></i></a>
                </div>
            </form>
        </div>
    </div>
